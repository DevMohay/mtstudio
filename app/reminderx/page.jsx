...
export default function ReminderXStorePage() {
  const screenshots = ["/1.jpg", "/2.jpg", "/3.jpg"];

  const features = [
    "Create, Edit & Delete tasks easily",
    "Set due date & time reminders with notifications",
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
      ...
      <div className=" m-auto max-w-7xl relative">
        <Image
          src="/remiderX banner.png"
          alt="ReminderX Banner"
          width={0}
          height={0}
          sizes="100vw"
      ...
      <div className="px-4 lg:px-6 md:px-6 max-w-5xl mx-auto -mt-16 relative z-10">
        ...
        <motion.div
          ...
          className="bg-neutral-900/80 backdrop-blur rounded-2xl shadow-lg p-2 lg:p-6 md:p-6 flex gap-6 items-center"
        >
          <Image
            src="/reminderX Logo.png"
            alt="ReminderX Logo"
            width={100}
            height={100}
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold">ReminderX</h1>
            <p className="text-neutral-400 lg:text-lg text-sm">Advanced Todo & Reminder App</p>
            <a
              href="./reminderx.apk"
              target="_blank"
        ...
        <section className="mt-10">
          ...
          <p className="text-neutral-300 leading-relaxed">
            ReminderX is a modern Todo & Reminder app built to manage your daily
            tasks efficiently. It helps you stay productive with smart
            reminders, priority-based organization, and real-time notifications
            — all packed in a clean, minimal interface.
          </p>
        </section>
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            <div>
              ...
              <p className="mt-2 text-neutral-300 max-w-lg">
                I build practical, user-friendly digital tools that solve
                real-world problems. ReminderX is designed to boost productivity
                and help people stay on top of their tasks.
              </p>
